...
describe("OrchParser", function() {
	...
	describe("constructor", function() {
		...
		it("should handle real data", function() {
			var sow_quote_costs = "Additional Resource Units -GST Excl	Quanity	RU Price(per month)	Unit Extended Price	Total Contract Value\n Firewall-Infrastructure-New-Complex (WX-C9999-X)	2\t$ 1,837.33 $ 3,674.66	$ 176,383.68\n Firewall-Support line 1	\t2\t$ 324.44	$ 648.88	$ 31,146.24\nFirewall-Support xline	2	$ 324.44	$ 648.88	$ 31,146.24\nFirewall-Infrastructure-New-Complex (ASA5585)	2	$    - $   -	$  -\n Firewall-Infrastructure-New-Complex (WS-c4999-F)	2\t$ 1,837.33 $ 3,674.66	$ 176,383.68\n Firewall-Support YYYY	2\t$324.44	$648.88	$31,146.24\n Firewall-Infrastructure-New-Blah (Cat4506)	2	$ 470.97 $ 1,883.88	$ 90,426.24\n"; 
			var expect_arr_line1 = ["(WX-C9999-X)", " Firewall-Infrastructure-New-Complex ", "WX-C9999-X"];
			var expect_arr_line6 = ["", " Firewall-Support YYYY	2	$324.44	$648.88	$31,146.24", ""];
			// var expected_arr = [["", " Additional Resource Units -GST Excl	Quanity	RU Price(per month)	Unit Extended Price	Total Contract Value", ""],
			// ["(WX-C9999-X)", " Firewall-Infrastructure-New-Complex ", "WX-C9999-X"],
			// ["", " Firewall-Support line 1	2	$ 324.44	$ 648.88	$ 31,146.24", ""],
			// ["", "Firewall-Support xline	2	$ 324.44	$ 648.88	$ 31,146.24", ""],
			// ["(ASA5585)", "Firewall-Infrastructure-New-Complex ", "ASA5585"],
			// ["(WS-c4999-F)", " Firewall-Infrastructure-New-Complex ", "WS-c4999-F"],
			// ["", " Firewall-Support YYYY	2	$ 324.44	$ 648.88	$ 31,146.24", ""],
			// ["(Cat4506)", " Firewall-Infrastructure-New-Blah ", "Cat4506"],
			// ["", "", ""] ];
			var res=OrchParser.preparse_array_of_strings(/\(([A-Za-z0-9\-]*)\)/, sow_quote_costs);
			console.log(res[1]);
			console.log(expect_arr_line1);
			var compare_res=compare_arrays(res[1], expect_arr_line1);
			expect(compare_res).to.equal(true);
			var compare_res=compare_arrays(res[6], expect_arr_line6);
			// console.log(res);
...
// 				console.log(res);
// 				var expected=[["WX-C9999-X", ",Firewall - Infrastructure - New - Complex after, component 1, component 2, "]];
// 				var compare_res=compare_arrays(res, expected);
// 				expect(compare_res).to.equal(true);
// 			});
// 			});
